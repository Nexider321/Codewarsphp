<?php
# Создать ассоациативный массив с желаемый листом
# и создать ассоацитвный массив с подарками 
# нужно сравнить подарки с желаемый листом 
# и вернуть то что совпадает
/*
